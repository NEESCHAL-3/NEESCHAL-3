...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=15&duration=1800&pause=600&color=DC143C&center=true&vCenter=true&width=780&lines=Learning%2C+experimenting%2C+and+exploring;Compiling+custom+kernels+at+2%3A00+AM+for+that+sweet+%2B2+FPS;Spent+6+hours+debugging...+forgot+to+save+the+file;Turning+caffeine+into+segmentation+faults+since+day+one;OrangeFox+recovery%3A+where+bad+decisions+become+backups;Bootloop+is+just+the+device+meditating+really+hard;Why+write+10+lines+of+Python+when+500+lines+of+C+will+do%3F;Fastboot+is+my+therapist;git+push+--force+and+let+tomorrow%27s+me+deal+with+the+trauma;If+it+works+on+my+machine%2C+then+we+ship+my+machine;The+code+works.+I+don%27t+know+why.+Don%27t+touch+it.;Commenting+out+failing+tests+so+the+CI+pipeline+turns+green;Windows+Update+restarting+at+99%25+during+unsaved+builds;Changing+one+line+and+rebuilding+the+entire+Android+tree;WSL2+politely+consuming+31.9+GB+of+my+32+GB+RAM;Studying+CSE%3A+10%25+coding%2C+90%25+deciphering+compiler+errors;My+phone+bootlooped+so+many+times+it+knows+my+name;Never+fear+a+bricked+phone%2C+only+fear+an+empty+backup;0+warnings%2C+0+errors...+wait%2C+something+is+terribly+wrong;Clean+build%3F+Nah%2C+I+like+living+dangerously;A+full+day+of+coding+can+save+15+minutes+of+reading+docs;SELinux+denial+logs+are+my+daily+reading+material;My+code+works+and+I+don%27t+know+why...+peak+impostor+syndrome;%2F%2F+TODO%3A+fix+this+temporary+hack+(written+4+years+ago);git+commit+-m+%27fixed+bug+for+real+this+time+v4+final+FINAL%27;The+build+failed+because+I+looked+at+it+wrong;rm+-rf+%2Fvendor%2Fbuild.prop+and+inshallah+it+boots;Real+developers+test+in+production+with+unlocked+bootloaders;Kernel+compiled+successfully.+Now+let%27s+see+if+it+explodes.;I+use+Arch+btw+until+an+update+nukes+the+display+manager;Gentoo+users+compiling+Firefox+to+heat+up+the+room;Exiting+Vim+by+pulling+the+computer+cord+from+the+wall;sudo+make+me+a+sandwich;void+***ptr+entered+the+chat+and+my+sanity+vanished" alt="Typing SVG" />
